...
const url=require("url"),externalLink=e=>{if(!e||!e.getAttribute)return!1;if(e.getAttribute("target")&&"_self"!==e.getAttribute("target"))return!0;if("external"===e.getAttribute("rel"))return!0;const t=e.getAttribute("href");return!!t.match(/^\w+:/)||!!t.match(/^\/\//)},extlink=(e={})=>{const t={title:"External Link Title",ariaLabel:"SVG Aria Label",exclude:[],target:"_blank",rel:"noopener",strokeColor:"",className:""};for(const r in t)void 0===e[r]&&(e[r]=t[r]);if(void 0===e.svgfile){let t="";e.strokeColor&&(t=`<style>.stroke-color{stroke: ${e.strokeColor};</style>`),e.svgfile=`<svg class="svg-icon" aria-label="${e.ariaLabel}" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">${t}<g><polyline class="stroke-color" points="9.3,5.4 9.3,9.3 0.7,9.3 0.7,0.7 4.8,0.7 "/><polyline class="stroke-color" points="7,0.7 9.3,0.7 9.3,3.2 "/><line class="stroke-color" x1="9.3" y1="0.7" x2="5.5" y2="4.5"/></g></svg>`}const r=document.querySelectorAll("a[href]");[].forEach.call(r,t=>{if(externalLink(t)){const r=t.getAttribute("href"),l=url.parse(r).hostname;l&&!e.exclude.includes(l.replace(/www./g,""))&&(t.title||(t.title=e.title),t.target||(t.target=e.target),t.rel||(t.rel=e.rel),t.className+=` ${e.className}`,t.innerHTML+=e.svgfile,t.addEventListener("click",r=>{r.stopPropagation(),r.preventDefault(),void 0!==t.dataset.functionname&&(window[t.dataset.functionname](e,t.dataset),r.stopPropagation(),r.preventDefault())},!1))}})};module.exports=extlink;
