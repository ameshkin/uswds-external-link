(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.extlink = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
const url=require("url"),externalLink=(e,t)=>{if(!e||!e.getAttribute)return!1;if(e.getAttribute("target")&&"_self"!==e.getAttribute("target"))return!0;if("external"===e.getAttribute("rel"))return!0;const r=e.getAttribute("href");if(t){if(r.match(/^\w+:/))return!0}else if(r.match(/^\w+:/))return!1;return!!r.match(/^\/\//)},extlink=(e={})=>{const t={title:"External Link Title",ariaLabel:"SVG Aria Label",exclude:[],target:"_blank",rel:"noopener",showForMail:1,strokeColor:"",className:""};for(const r in t)void 0===e[r]&&(e[r]=t[r]);if(void 0===e.svgfile){let t="";e.strokeColor&&(t=`<style>.stroke-color{stroke: ${e.strokeColor};</style>`),e.svgfile=`<svg class="svg-icon" aria-label="${e.ariaLabel}" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">${t}<g><polyline class="stroke-color" points="9.3,5.4 9.3,9.3 0.7,9.3 0.7,0.7 4.8,0.7 "/><polyline class="stroke-color" points="7,0.7 9.3,0.7 9.3,3.2 "/><line class="stroke-color" x1="9.3" y1="0.7" x2="5.5" y2="4.5"/></g></svg>`}const r=document.querySelectorAll("a[href]");[].forEach.call(r,t=>{if(externalLink(t,e.showForMail)){const r=t.getAttribute("href"),l=url.parse(r).hostname;l&&!e.exclude.includes(l.replace(/www./g,""))&&(t.title||(t.title=e.title),t.target||(t.target=e.target),t.rel||(t.rel=e.rel),t.className+=` ${e.className}`,t.innerHTML+=e.svgfile,t.addEventListener("click",r=>{void 0!==t.dataset.functionname&&(window[t.dataset.functionname](e,t.dataset),r.stopPropagation(),r.preventDefault())},!1))}})};module.exports=extlink;
